...
import thuchanh.jwt.rest.CustomAccessDeniedHandler;
import thuchanh.jwt.rest.JwtAuthenticationTokenFilter;
import thuchanh.jwt.rest.RestAuthenticationEntryPoint;

@Configuration
@EnableWebSecurity
@ComponentScan("thuchanh.jwt")
